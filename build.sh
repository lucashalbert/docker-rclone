...
for docker_arch in amd64 arm32v6 arm64v8; do
    case ${docker_arch} in
        amd64   ) qemu_arch="x86_64"  rclone_arch="amd64" image_arch="amd64" ;;
        arm32v6 ) qemu_arch="arm"     rclone_arch="arm"   image_arch="arm"   ;;
        arm64v8 ) qemu_arch="aarch64" rclone_arch="arm64" image_arch="arm64" ;;
    esac
